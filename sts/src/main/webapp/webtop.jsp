...
<head>
    ...
    <!-- <script type="text/javascript" src="./administrator/1.0.0/js/ControlPanel.js"></script>
    <script type="text/javascript" src="./administrator/1.0.0/js/CmpSetting.js"></script>-->
