...
Ext.define('Ext.ux.desktop.Desktop',
{
	...
	// 根据ID调用某窗口
	onCreateWindow : function(w_id) {
		var me = this, module = me.app.getModule(w_id), win = module
				&& module.createWindow();
		if (win) {
			me.restoreWindow(win);
		}
	...
	// 生成json树
	//id, 数据源,　根节点是否可见, 是否展开, 根节点文字
	generateTree : function(id, data, rootvisible, expand,
			roottext) {
